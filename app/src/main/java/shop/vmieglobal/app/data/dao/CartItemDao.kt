package shop.vmieglobal.app.data.dao
...
interface CartItemDao {
    ...
    @Transaction
    suspend fun incrementProductQuantityOrAdd(product: VMGLOProduct) {
    ...
    @Transaction
    suspend fun decrementProductQuantityOrRemove(product: VMGLOProduct) {
