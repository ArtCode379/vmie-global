package shop.vmieglobal.app.ui.composable.approot
...
import shop.vmieglobal.app.ui.composable.navigation.AppNavHost
import shop.vmieglobal.app.ui.composable.navigation.NavRoute
...
@Composable
fun AppRoot(
    viewModel: VMGLOAppViewModel = koinViewModel()
) {
