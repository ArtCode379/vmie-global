package shop.vmieglobal.app.ui.composable.screen.checkout
...
@Composable
fun VMGLOCheckoutScreen(
    modifier: Modifier = Modifier,
    viewModel: VMGLOCheckoutViewModel = koinViewModel(),
    onNavigateToVMGLOOrdersScreen: () -> Unit,
) {
    ...
    if (orderState is DataUiState.Populated) {
        CheckoutDialog(
            ...
            onConfirm = onNavigateToVMGLOOrdersScreen
        )
    }
